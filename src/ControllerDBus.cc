...
ControllerDBus::ControllerDBus(DBusConnection *conn_)
  : _login(""), _server(""),
 ...
 */
void
ControllerDBus::newFetch(int number,
                         const char *login,
                         const char *server,
                         int size)
{
 ...
 */
void
ControllerDBus::newMessage(const char *login,
                           const char *server,
                           int index,
                           int number,
                           int size)
